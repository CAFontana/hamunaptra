...
function CorsecBaseScreenPlay:spawnMobiles()
    ...
    spawnMobile("corellia", "laen_pieweto",math.rad(2700, 3300),1.5,-20.8,33.4,-179,1855730,true) --Raid Boss, 45-55 min respawn rate
	...
	spawnMobile("corellia", "nabek_naga",math.rad(2700, 3300),5226.8,5.0,1580.8,-34,0,true) --<<Boss before Bunker entrance>> Random Respawn 45-55min
